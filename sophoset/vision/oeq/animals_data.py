...
class AnimalsDataset(BaseHFDataset):
    """A class to handle loading and interacting with the Animals dataset."""

    DATASET_NAME = "dgrnd4/animals-10"

    def __init__(self):
        """Initialize the Animals dataset handler.
        """
