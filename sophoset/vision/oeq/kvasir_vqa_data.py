...
class KvasirVQADataset(BaseHFDataset):
    """A class to handle loading and interacting with the Kvasir VQA dataset."""

    DATASET_NAME = "SimulaMet-HOST/Kvasir-VQA"

    def __init__(self):
        """Initialize the Kvasir VQA dataset handler.
        """
