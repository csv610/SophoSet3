...
class SNLIVEDataset(BaseHFDataset):
    """A class to handle loading and interacting with the SNLI-VE dataset."""

    DATASET_NAME = "SNLI-VE"
    ...
    def extract_row_data(self, row: Dict[str, Any], index: int) -> QAData:
        ...
        question = f"Does this image entail the following statement: {hypothesis}"
